...
def get_rarity_box(rarity):
    switch = {0: "Common", 1: "Epic", 2: "Legendary"}
    return switch[rarity]

def get_rarity_shinobi(rarity):
    switch = {0: "Academy Student", 1: "Genin",
     2: "Chūnin", 3: "Tokubetsu Jōnin", 4: "Jōnin", 5: "Kage"}
    return switch[rarity]
